...
<body>
	...
	<div>
			<button class="layui-btn bt_add" data="893px, 550px" data-url="${ctx}/role/toRoleAdd">新增</button>
			<button class="layui-btn layui-btn-warm bt_update" data="893px, 550px" data-url="${ctx}/role/toRoleUpdate">修改</button>
			<button class="layui-btn layui-btn-danger bt_delete" data-url="${ctx}/role/roleDelete">删除</button>
			<button class="layui-btn layui-btn-normal bt_setMenu" data="893px, 550px" data-url="${ctx}/role/toRoleSetMenu">分配权限</button>
	</div>
